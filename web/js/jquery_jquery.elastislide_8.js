...
instance.$slider.css({width:instance.sliderW+ 10});clearTimeout(instance.resetTimeout);instance.resetTimeout=setTimeout(function(){instance._slideToCurrent();},200);});this.$navNext.bind('click.elastislide',function(event){instance._slide('right');});this.$navPrev.bind('click.elastislide',function(event){instance._slide('left');});this.$items.bind('click.elastislide',function(event){instance.options.onClick($(this));return true;});instance.$slider.touchwipe({wipeLeft:function(){instance._slide('right');},wipeRight:function(){instance._slide('left');}});},_slide:function(dir,val,anim,callback){if(this.$slider.is(':animated'))
...
return this;};})(window,jQuery);$(function(){$('#carousel').elastislide({imageW:201,minItems:1,easing:'',margin:0,border:0});});