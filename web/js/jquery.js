...
$(document).ready(function(){$(".gallery ul.album li a").fancybox()});
$(document).ready(function(){$("#events-list").jcarousel({scroll:2})});
$(document).ready(function(){$("#bottom-menu").jcarousel();$("#events-list2").jcarousel({scroll:2})});
...
Sliderman.slider = function(parameters){
  ...
  //EVENTS
  var events = parameters.events, eventCall = events ? function(e){
...
Sliderman.order({
  ...
  method: function(e){
    ...
    var a = [], i = 0, c = 0, r = 0, cl = cols - 1, rl = rows - 1, il = count - 1, cr;
    switch(road){
      case 'BL': case 'TR': case 'TL': case 'BR':
        var C = 0, R = 0;
        break;
      case 'LB': case 'RT': case 'LT': case 'RB': default:
        road = 'RB';
        var C = cl, R = 0;
        break;
    }
      ...
      if(c < 0 || r < 0 || c > cl || r > rl){
        switch(road){
          case 'BL': case 'TR':
            C++;
            break;
          case 'LB': case 'RT': case 'TL': case 'BR':
            R++;
            break;
          case 'RB': case 'LT': default:
            C--;
...
{
  if (src.indexOf('?') != -1)
    return '/bundles/mymain/swf/' + src.replace(/\?/, ext+'?'); 
  else
    return '/bundles/mymain/swf/' + src + ext;
}
