...
/* MYMainBundle:Main:events.html.twig */
class __TwigTemplate_875ab1b84c041798cbd5544f84f30845366a8e9b8d475eb339b12d83662e60b5 extends Twig_Template
{
    ...
    {
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("events.keywords"), "html", null, true);
    }

    // line 6
    public function block_description($context, array $blocks = array())
    {
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("events.description"), "html", null, true);
    }
  ...
  <h2 class=\"content-title-";
        ...
        echo "\">";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("menutop.events"), "html", null, true);
        echo "</h2>
  ";
        // line 11
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["event"]) {
            // line 12
            echo "    <div class=\"item-row-a clearfix\">
      <h3 class=\"title1\">
        <a href=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("my_event_detailed", array("category_slug" => $this->getAttribute($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "eventCatId"), "slug"), "event_slug" => $this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "slug"))), "html", null, true);
            echo "\">";
        ...
        <p class=\"title2\">";
            // line 16
            if ($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "eventCatId")) {
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "eventCatId"), "name"), "html", null, true);
            }
            echo "</p>
      <a href=\"";
            // line 17
        ...
        ";
            // line 18
            if (($this->getAttribute((isset($context["event"]) ? $context["event"] : null), "image", array(), "any", true, true) && (!(null === $this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "image"))))) {
                // line 19
                echo "          <img src=\"";
                echo $this->env->getExtension('sonata_media')->path($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "image"), "list");
                echo "\" class=\"event_img\" alt=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "title"), "html", null, true);
                echo "\" />
\t";
            }
            // line 21
            echo "        ";
            if (($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "new") == "1")) {
                // line 22
                echo "         <div class=\"new_img\">
           <img src=\"/bundles/mymain/images/new-";
                // line 23
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request"), "attributes"), "get", array(0 => "_locale"), "method"), "html", null, true);
                echo ".png\" alt=\"new\" />
         </div>
      ...
      <div class=\"each_event_text_title\">";
            // line 27
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "startDate"), "d/m/Y"), "html", null, true);
            echo "</div>
      <div class=\"each_event_text_title\">";
            // line 28
      ...
      ";
            // line 29
            if ($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "eventPlaceId")) {
                // line 30
                echo "        <div class=\"each_event_text_title\">
          <div class=\"middle_info_img_info middle_info_img\"></div>
          <div class=\"middle_content\">
            <div class=\"middle_content_c\">
              <p>";
                // line 34
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "eventPlaceId"), "name"), "html", null, true);
                echo "</p>
            </div>
          </div>
        </div>
      ...
      <div class=\"intro\"> ";
            // line 40
            echo $this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "contentShort");
            echo " <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("my_event_detailed", array("category_slug" => $this->getAttribute($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "eventCatId"), "slug"), "event_slug" => $this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "slug"))), "html", null, true);
            echo "\" class=\"read-more\">";
...
";
    ...
    {
        return "MYMainBundle:Main:events.html.twig";
    }
