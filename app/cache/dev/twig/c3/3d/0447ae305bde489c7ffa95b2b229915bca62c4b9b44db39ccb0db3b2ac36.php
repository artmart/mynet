...
/* MYMainBundle:Suggestion:block.html.twig */
class __TwigTemplate_c33d0447ae305bde489c7ffa95b2b229915bca62c4b9b44db39ccb0db3b2ac36 extends Twig_Template
{
    ...
    <span class=\"list-title-text\">
      ";
        ...
        if (array_key_exists("discus", $context)) {
            ...
            // line 7
            echo "        ";
            $context["curl"] = $this->env->getExtension('routing')->getPath("suggestion", array("slug" => $this->getAttribute((isset($context["suggestion"]) ? $context["suggestion"] : $this->getContext($context, "suggestion")), "slug")));
            // line 8
            echo "      ";
        }
        // line 9
  ...
  <br class=\"fcl\" />
    ...
    {
        return "MYMainBundle:Suggestion:block.html.twig";
    }
