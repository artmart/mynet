...
/* MYMainBundle:Suggestion:topBlock.html.twig */
class __TwigTemplate_ed5853974bf855e8b4d34579fcf56b889d6f458922ec26a6dbc16d2e7e54e640 extends Twig_Template
{
    ...
    <span class=\"list-title-text\">
      ";
        ...
        if (array_key_exists("discus", $context)) {
            ...
            // line 7
            echo "        ";
            $context["curl"] = $this->env->getExtension('routing')->getPath("top_suggestion", array("slug" => $this->getAttribute((isset($context["suggestion"]) ? $context["suggestion"] : $this->getContext($context, "suggestion")), "slug")));
            // line 8
            echo "      ";
        }
        // line 9
  ...
  <br class=\"fcl\" />
    ...
    {
        return "MYMainBundle:Suggestion:topBlock.html.twig";
    }
