...
namespace Proxies\__CG__\MY\MediaBundle\Entity;

/**
 * THIS CLASS WAS GENERATED BY THE DOCTRINE ORM. DO NOT EDIT THIS FILE.
 */
class Media extends \MY\MediaBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'description', 'enabled', 'providerName', 'providerStatus', 'providerReference', 'providerMetadata', 'width', 'height', 'length', 'contentType', 'size', 'copyright', 'authorName', 'context', 'cdnIsFlushable', 'cdnFlushAt', 'cdnStatus', 'updatedAt', 'createdAt', 'id', 'in_homepage', 'galleryHasMedias');
    }
