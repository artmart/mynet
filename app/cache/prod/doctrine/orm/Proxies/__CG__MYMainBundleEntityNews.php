 ...
 */
class News extends \MY\MainBundle\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setNewsStatus($newsStatus);
    }

    public function getNewsStatus()
    {
        $this->__load();
        return parent::getNewsStatus();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'slug', 'title', 'content', 'short_content', 'news_status', 'homepage_status', 'news_date', 'created', 'updated', 'meta_title', 'meta_desc', 'meta_kw', 'translations', 'image', 'gallery');
    }
