 ...
 */
class Concurs extends \MY\MainBundle\Entity\Concurs implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setConcursStatus($concursStatus);
    }

    public function getConcursStatus()
    {
        $this->__load();
        return parent::getConcursStatus();
    }
    ...
    {
        $this->__load();
        return parent::setConcursDate($concursDate);
    }

    public function getConcursDate()
    {
        $this->__load();
        return parent::getConcursDate();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'slug', 'title', 'content', 'short_content', 'concurs_status', 'homepage_status', 'concurs_date', 'created', 'updated', 'meta_title', 'meta_desc', 'meta_kw', 'image', 'gallery');
    }
