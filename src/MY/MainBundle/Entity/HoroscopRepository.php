 ...
 */
class HoroscopRepository extends EntityRepository
{

  public function findAllHoroscops()
  {
  ...
  public function findAllHoroscopArchive()
  {
    $query = $this->getEntityManager()
  ...
  public function findAllHomepageHoroscop()
  {
    $query = $this->getEntityManager()
