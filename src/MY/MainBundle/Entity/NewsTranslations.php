 ...
 *     uniqueConstraints={@ORM\UniqueConstraint(name="news_trans_lookup_unique_idx", columns={
 *         "locale", "object_id", "field"
 *     })}
 * )
 */
class NewsTranslations extends AbstractPersonalTranslation
{
   ...
   * Set object
   *
   * @param MY\MainBundle\Entity\News $object
   ...
   * Get object
   *
   * @return \MY\MainBundle\Entity\News 
   */
