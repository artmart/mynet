 ...
 *     uniqueConstraints={@ORM\UniqueConstraint(name="gallery_trans_lookup_unique_idx", columns={
...
class GalleryTranslations extends AbstractPersonalTranslation
{
   ...
   * Set object
   *
   * @param \MY\MainBundle\Entity\Gallery $object
   * @return GalleryTranslations
   */
   ...
   * Get object
   *
   * @return \MY\MainBundle\Entity\Gallery 
   */
