...
class InterestingsAdmin extends Admin {
  ...
  protected function configureShowField(ShowMapper $showMapper) {
    $showMapper
            ...
            ->add('status', null, array('label' => 'Interestings Status'))
            ->add('_date', 'date', array('label' => 'Interestings Date', 'format' => 'yyyy-MM-dd','widget' => 'single_text'))
  ...
  protected function configureListFields(ListMapper $listMapper) {
    $listMapper
            ...
            ->addIdentifier('name')
            ->addIdentifier('status', null, array('label' => 'Interestings Status'))
  ...
  protected function configureFormFields(FormMapper $formMapper) {
   // $languages = $this->configurationPool->getContainer()->getParameter('languages');
    ...
    $formMapper
            ...
            ->add('_date', 'date', array('widget' => 'choice', 'required' => false))
            ->add('status', 'choice', array('choices' => array('1' => 'On', '0' => 'Off'),'required' => true))
            ->add('type', 'choice', array('choices' => array('1' => 'For Men', '2' => 'For Women', '3' => 'For KIds'),'required' => true))
            ...
            ->add('gallery', 'sonata_type_model_list', array('required' => false), array('link_parameters' => array('context' => 'interestings_gallery')))
            ->end()
            /*->with('Translations')
