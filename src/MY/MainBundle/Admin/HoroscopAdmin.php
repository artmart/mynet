...
class HoroscopAdmin extends Admin {
  ...
  protected function configureShowField(ShowMapper $showMapper) {
    $showMapper
            ...
            ->add('status', null, array('label' => 'Horoscop Status'))
            ->add('_date', 'date', array('label' => 'Horoscop Date', 'format' => 'yyyy-MM-dd','widget' => 'single_text'))
  ...
  protected function configureListFields(ListMapper $listMapper) {
    $listMapper
            ...
            ->addIdentifier('name')
            ->addIdentifier('status', null, array('label' => 'Horoscop Status'))
  ...
  protected function configureFormFields(FormMapper $formMapper) {
    ...
    $formMapper
            ...
            ->add('type', 'choice', array('choices' => array('1' => 'Horoscop 1', '2' => 'Horoscop 2', '3' => 'Horoscop 3'),'required' => true))
            ...
            ->add('gallery', 'sonata_type_model_list', array('required' => false), array('link_parameters' => array('context' => 'horoscop_gallery')))
            ->end()
            /*->with('Translations')
