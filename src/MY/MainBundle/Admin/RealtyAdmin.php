...
class RealtyAdmin extends Admin {
  ...
  protected function configureShowField(ShowMapper $showMapper) {
    $showMapper
            ...
            ->add('status', null, array('label' => 'Realty Status'))
            ->add('_date', 'date', array('label' => 'Realty Date', 'format' => 'yyyy-MM-dd','widget' => 'single_text'))
  ...
  protected function configureListFields(ListMapper $listMapper) {
    $listMapper
            ...
            ->addIdentifier('name')
            ->addIdentifier('status', null, array('label' => 'Realty Status'))
  ...
  protected function configureFormFields(FormMapper $formMapper) {
    ...
    $formMapper
            ...
            ->add('type', 'choice', array('choices' => array('1' => 'Legislation', '2' => 'Dealing', '3' => 'Registration', '4' => 'Rent', '5' => 'Consultation'),'required' => true))
            ...
            ->add('gallery', 'sonata_type_model_list', array('required' => false), array('link_parameters' => array('context' => 'realty_gallery')))
            ->end()
            /*->with('Translations')
