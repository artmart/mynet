...
class ConcursAdmin extends Admin {
  ...
  protected function configureShowField(ShowMapper $showMapper) {
    $showMapper
            ...
            ->add('concurs_status', null, array('label' => 'Concurs Status'))
            ->add('concurs_date', 'date', array('label' => 'Concurs Date', 'format' => 'yyyy-MM-dd','widget' => 'single_text'))
  ...
  protected function configureListFields(ListMapper $listMapper) {
    $listMapper
            ...
            ->addIdentifier('name')
            ->addIdentifier('concurs_status', null, array('label' => 'Concurs Status'))
  ...
  protected function configureFormFields(FormMapper $formMapper) {
    ...
    $formMapper
            ...
            ->add('concurs_date', 'date', array('widget' => 'choice', 'required' => false))
            ->add('concurs_status', 'choice', array('choices' => array('1' => 'On', '0' => 'Off'),'required' => true))
